...
public class Trebuche extends Unit {
	...
	public int count_trebuche=0;
	
	public Trebuche(String civName, InputStream in, String tag) {
		// TODO Auto-generated constructor stub
		Retriever retrieveIt = new Retriever("Spanish", in, "unit", "trebuche","workshop");
